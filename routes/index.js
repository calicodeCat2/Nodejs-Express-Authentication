...
router.post('/register', function(req, res, next) {
  ...
  req.checkBody('email', 'Email address must be between 8-100 characters long.').len(4, 100);
  ...
  bcrypt.hash(password, saltRounds, function(err, hash) {   // Store hash in your password DB.
